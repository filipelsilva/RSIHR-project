...
class Robot:
    ...
    # INITIATE AN OBJECT INSTANCE OF THE SPEECH CLASS
    mw_speech = mw.Speech()
    ...
    def __init__(self):
        ...
        # INIT THE SPEECH ATTRIBITUTES (see Speech class in middleware.py and speech driver)
        self.speech_ready = self.mw_speech.ready
        self.speech_language = self.mw_speech.language
        self.speech_say = self.mw_speech.say
        self.speech_saying = self.mw_speech.saying
    ...
    def update(self):
        ...
        # UPDATE THE SPEECH ATTRIBITUTES (see Speech class in middleware.py and speech driver)
        self.speech_ready = self.mw_speech.ready
        self.speech_language = self.mw_speech.language
        self.speech_say = self.mw_speech.say
        self.speech_saying = self.mw_speech.saying
    ...
    # CREATE THE SPEAK FUNCTION THAT TELLS THE SPEECH OBJECT THAT IT SHOULD SPEAK
    def speak(self, text, language):
        ...
        """
        self.mw_speech.language = language
        self.mw_speech.say = text
    ...
    def start_video_recording(self):
        self.mw_camera.record = True
        return True, "OK"

    def stop_video_recording(self):
        self.mw_camera.record = False
        return True, "OK"
...
def command():
    try:
        ...
        elif op == "start_video_recording":
            success, message = robot.start_video_recording()
        elif op == "stop_video_recording":
            success, message = robot.stop_video_recording()
        elif op == "set_screen":
            image = req["image"]
            video = req["video"]
            text = req["text"]
        ...
        # MAKE SURE THE REST COMMAND FOR SPEECH EXISTS
        elif op == "speak":
            text = req["text"]
            language = req["language"]
            success, message = robot.speak(text, language)
        else:
